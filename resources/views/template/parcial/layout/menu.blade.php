<ul class="sidebar-menu" data-widget="tree">
	...
	@if(ViewHelper::hasMainRole('Súper usuario') || ViewHelper::hasMainRole('Administrador'))
		<li id="mInstitutionModule" class="treeview">
			...
			<ul class="treeview-menu">
				<li id="miInstitutionInsert"><a href="{{url('institution/insert')}}"><i class="fa fa-circle-o"></i> Nueva institución</a></li>
	...
	@if(ViewHelper::hasMainRole('Súper usuario') || ViewHelper::hasMainRole('Administrador'))
		<li id="mUgelModule" class="treeview">
			...
			<ul class="treeview-menu">
				<li id="miUgelInsert"><a href="{{url('ugel/insert')}}"><i class="fa fa-circle-o"></i> Nueva UGEL</a></li>
				<li id="miUgelGetAll"><a href="{{url('ugel/getall/1')}}"><i class="fa fa-circle-o"></i> Lista de UGELs</a></li>
			</ul>
		</li>
	@endif
	@if(ViewHelper::hasMainRole('Súper usuario') || ViewHelper::hasMainRole('Administrador'))
		<li id="mDistrictModule" class="treeview">
			...
			<ul class="treeview-menu">
				<li id="miDistrictInsert"><a href="{{url('district/insert')}}"><i class="fa fa-circle-o"></i> Nuevo distrito</a></li>
				<li id="miDistrictModuleGetAll"><a href="{{url('district/getall/1')}}"><i class="fa fa-circle-o"></i> Lista de distritos</a></li>
			</ul>
		</li>
	@endif
	@if(ViewHelper::hasMainRole('Súper usuario') || ViewHelper::hasMainRole('Administrador'))
